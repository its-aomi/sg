	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
			<head>
				...
				<xsl:variable name="tableMinWidth" select="'700'"/><xsl:variable name="colorMain" select="'#222222'"/><xsl:variable name="colorAccent" select="'#00a0d2'"/><xsl:variable name="relativeFontColor" select="'#ffffff'"/><title>XML Sitemap &#x2d; SimplifiedGuide.net</title>
	...
	#description a:hover, #footer a:hover {
		border-bottom: none;
			...
			<body class="ltr">
				<div id="description">
					<div class="wrap">
						<a href="http://localhost/simplifiedguide"><h1><img src="http://localhost/simplifiedguide/wp-content/uploads/2022/08/SG-150x150.png" width="29" height="29" />SimplifiedGuide.net — XML Sitemap</h1></a>
<p>
